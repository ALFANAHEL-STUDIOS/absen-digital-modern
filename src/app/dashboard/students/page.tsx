                ...
                <div className="p-4">
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      <span className="inline-block px-1.5 py-0.5 text-xs bg-purple-100 text-gray-500 rounded">
                        {student.class}
                      </span>
                      <span className="inline-block px-1.5 py-0.5 text-xs bg-blue-100 text-gray-500 rounded ml-2">
